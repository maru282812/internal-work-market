!(() => {
  ...
  var r,
    ...
    L = function (t, e) {
      return arguments.length < 2 ? (T((r = i[t])) ? r : void 0) : i[t]?.[e];
      var r;
    },
    U = b({}.isPrototypeOf),
    N = i.navigator,
  ...
  var W = n,
    ...
    ht = i.Symbol,
    pt = nt("wks"),
    vt = $ ? ht.for || ht : ht?.withoutSetter || lt,
    dt = (t) => (
    ...
    Fo = {
      ...
      setStrong: (t, e, r) => {
        ...
        Rn(
          ...
          function () {
            for (var t = i(this), e = t.kind, r = t.last; r?.removed; )
              r = r.previous;
  ...
  for (var ti in Go) Zo(i[ti]?.prototype, ti);
  Zo(Xo, "DOMTokenList");
  var ei = (t, e, r) =>
    function (n) {
      var o = it(n),
  ...
  var Ji = Math.floor,
    Qi =
      Number.isInteger || ((t) => !M(t) && Number.isFinite(t) && Ji(t) === t);
  ...
  var Ky,
    ...
    bm = im.f,
    wm = bm,
    Sm = !!(ym?.createEvent && i.dispatchEvent),
